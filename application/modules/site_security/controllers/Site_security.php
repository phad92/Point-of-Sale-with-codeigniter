...
class Site_security extends MX_Controller
{
    ...
    function user_exist_in_users_table(){
    ...
    function _check_session($session_id){
        $this->load->module('store_items');
        $mysql_query = "SELECT * FROM ci_sessions WHERE id = '$session_id'";
