...
class Welcome extends API_Controller
{
    ...
    function mypurchases($user_code){
        header("Access-Control-Allow-Origin: *");

        $this->load->library('download_lib');
        $this->load->model('downlaod_model');

        $payload = $this->download_model->get_user_downloads($user_code)->result_array();
        ...
        $this->_api_return_token($payload);
    }

    function _api_return_token($payload){
